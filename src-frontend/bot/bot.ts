...
import { CreateMockAdapterFactory, MockAdapter } from "../whats_socket/MockAdapter.js";
...
export default class Bot implements BotMinimalInfo {
  ...
  constructor(options?: WhatsBotOptions, optionalAdapter?: IWhatsappAdapter) {
    ...
    const socketVendorFactory = optionalAdapter ?? CreateMockAdapterFactory(new MockAdapter());
    this.InternalSocket =
