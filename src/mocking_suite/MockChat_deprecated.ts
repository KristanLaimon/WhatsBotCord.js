...
class MockingChatDeprecated {
  ...
  constructor(commandToTest: ICommand, additionalOptions?: MockingChatParams) {
    ...
    this._botOptions = {
      ...
      ownWhatsSocketImplementation_Internal: additionalOptions?.botSettings?.ownWhatsSocketImplementation_Internal,
...
const a = new MockingChatDeprecated({} as any, {} as any);
console.log(a);
